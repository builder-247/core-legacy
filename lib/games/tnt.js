...
module.exports = function (data, uuid) {
    ...
    const tnt = data.player.stats.TNTGames;
    ...
    const spleef_w_l = utility.getRatio(spleef_wins, spleef_losses);
    ...
    const wizards_k_d = utility.getRatio(wizards_kills, wizards_deaths);
