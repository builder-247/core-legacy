...
module.exports = function (data, uuid) {
    ...
    const k_d_1v1 = utility.getRatio(kills_1v1, deaths_1v1);
    const k_d_2v2 = utility.getRatio(kills_2v2, deaths_2v2);
    const k_d_4v4 = utility.getRatio(kills_4v4, deaths_4v4);

    const w_l_1v1 = utility.getRatio(wins_1v1, losses_1v1);
    const w_l_2v2 = utility.getRatio(wins_2v2, losses_2v2);
    const w_l_4v4 = utility.getRatio(wins_4v4, losses_4v4);
