...
module.exports = function (data, stats, uuid) {
    ...
    const twitter = links.TWITTER || "https://twitter.com/" + social.TWITTER || null;
    const youtube = links.YOUTUBE || "https://youtube.com/c/" + social.YOUTUBE || null;
    const instagram = links.INSTAGRAM || "https://www.instagram.com/" + social.INSTAGRAM || null;
    const twitch = links.TWITCH || "https://twitch.tv/" + social.TWITCH || null;
    const mixer = links.MIXER || "https://mixer.com/" + social.BEAM || null;
